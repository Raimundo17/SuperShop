...
namespace SuperShop.Helpers
{
    public class UserHelper : IUserHelper
    {
        ...
        public UserHelper(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<IdentityRole> roleManager) // no caso do RoleManager só uso o "dele" porque nao preciso de mais propriedades
        {
